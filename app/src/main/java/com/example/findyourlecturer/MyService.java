    ...
    public void onCreate() {
        ...
        for (int i = 0; i < wifiList.size(); i++) {
            ...
            if (wifis != null) {
                ...
                if (wifis[i].equals("KOS PUTRI KUNWAHYU LT2")) { //WIFI

                    WifiConfiguration wifiConfig = new WifiConfiguration();
                    wifiConfig.SSID = String.format("\"%s\"", wifis[i]);
                    wifiConfig.preSharedKey = String.format("\"%s\"", "08121963"); //PASSWORD
                ...
                else if (wifis[i].equals("KOS PUTRI KUNWAHYU LT3")) { //WIFI
